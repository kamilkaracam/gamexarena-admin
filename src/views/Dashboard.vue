<template>
  <v-container fill-height fluid grid-list-xl>
    <v-layout wrap>
      ...
      <v-flex sm6 xs12 md6 lg3>
        <material-stats-card color="orange" icon="mdi-content-copy" title="Used Space" value="49/50" small-value="GB"
                             sub-icon="mdi-alert" sub-icon-color="error" sub-text="Get More Space..."
      ...
      <v-flex md12 lg6>
        <material-card color="orange" title="Son katılan kullanıcılar" text="...">
